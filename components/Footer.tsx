      ...
      <div className='flex flex-col gap-12 w-full'>
        <div className='flex items-start flex-col'>
          <Image
            ...
            alt='Flexibble'
          />
          <p className='text-start text-sm font-normal mt-5 max-w-ws'>
            this is a short style showcase:text-start text-sm font-normal mt-5 max-w-ws
          </p>
          <div className='flex flex-wrap w-full gap-12'>
            {/* {footerLinks.map((item, index) => {
              if (index < 3)
                return <FooterColumn title={item.title} links={item.links} />
            })} */}
